...
Fuego is a decentralized p2p privacy blockchain banking network based from the CryptoNote protocol, that enables value within its network to inherit sound money properties and the benefits of modern private banking services like secure storage of value, untraceable peer-to-peer transfers, zero-knowledge [collateralization](https://github.com/usexfg/cold-dao) with zkSTARKs, & access to market-based interest yield on XFG.
